...
class FlightAndHotelRequest extends FormRequest
{
    /**
   ...
   public function rules()
    {
        return [
            ...
            'total_flight_and_hotel_reservation_travellers' => 'required|integer|min:1|max:8',
            ...
            'travellers' => [
                'array',
                Rule::requiredIf(fn () => (int) $this->input('total_flight_and_hotel_reservation_travellers') > 1),
    ...
    protected function validateTravellersCount()
    {
        return function ($attribute, $value, $fail) {
            $total = (int) $this->input('total_flight_and_hotel_reservation_travellers');
