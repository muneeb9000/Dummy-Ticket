...
class FlightReservationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'total_flight_reservation_travelers' => 'required|integer|min:1|max:8',
        ...
        'flights'                => 'required_if:flightReservation,yes|array',
        'flights.0'              => 'required_if:flightReservation,yes|string|max:255',
        'flights.*'              => 'nullable|string|max:255',
        'extra_flights'          => 'nullable|integer|min:3|max:9',
        'flight_additional_details' => 'exclude_if:flightReservation,no|nullable|string|max:2000',

        'hotelBooking'                  => 'required|in:yes,no',

        // only when hotelBooking === 'yes'
        'total_hotel_booking_travelers'   => 'exclude_if:hotelBooking,no|required|integer|min:1|max:8',
        ...
        'extra_hotels'                    => 'exclude_if:hotelBooking,no|nullable|integer|min:3|max:9',
    ...
    protected function validateTravellersCount()
    {
        return function ($attribute, $value, $fail) {
            $total = (int) $this->input('total_flight_reservation_travelers');
    ...
    public function messages()
    {
       ...
       'hotelBooking.required'               => 'Please let us know if you need hotel bookings.',
        ...
        'total_hotel_booking_travelers.required'
            => 'You must select the number of travelers when hotel booking is “yes.”',
        'total_hotel_booking_travelers.min'
            => 'At least one traveler is required.',
        'total_hotel_booking_travelers.max'
