...
var options1 = {
    ...
    colors: ["rgba(0, 203, 184, 0.3)", "rgba(0, 203, 184, 0.3)", "rgba(0, 203, 184, 0.3)", "rgba(0, 203, 184, 0.3)", "rgb(0, 203, 184)", "rgba(0, 203, 184, 0.3)", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed"],
    plotOptions: {
        bar: {
            columnWidth: '25%',
            distributed: true,
