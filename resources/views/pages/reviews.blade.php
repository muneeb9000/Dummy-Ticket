                        ...
                        <div class="grid grid-cols-1 md:grid-cols-[65%_35%] bg-primary gap-3">
                            ...
                            <div class="flex flex-col  text-[#1960A9] font-semibold text-sm">
                                ...
                                <div class="flex flex-col text-primary font-semibold text-sm">
                                    ...
                                    <!-- Top Static Row -->
                                    <div
                                        class="flex items-center justify-center bg-[#F4BD0F] h-[54px] px-2  space-x-2 border-[#1960A9] ">
                                    ...
                                    <div
                                        ...
                                        <p class="font-bold text-lg text-center">Dummy ticket for visa Client Reviews
                                            Page</p>
                                    </div>
                                    ...
                                    <div class="overflow-y-auto max-h-[450px] px-2 space-y-2 py-2 text-white">
                                        ...
                                        <div
                                            class="grid  [grid-template-columns:35%_63%]  gap-2 bg-[#1960A9] p-2 rounded shadow">
                                            <!-- Left (thumbnail/video) -->
                                            <div>
                                                <iframe class="w-[160px] h-[90px] "
                                            ...
                                            <div class=" text-sm text-left ">
                                                <p class="">Client review or testimonial content goes here for this row.
                                                </p>
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-[35%_65%] gap-2 bg-primary">
                                                <div class="relative">
                                                    <iframe class="w-full h-[90px]"
                                                        src="https://www.youtube.com/embed/6DFyNWt2kHs"
                                                        title="YouTube video player" frameborder="0" allowfullscreen>
                                                    </iframe>
                                                    <div class="absolute bottom-0 left-0 right-0 h-[1px] bg-white">
                                                    </div>
                                                </div>
                                                <div class="text-sm text-left">
                                                    <p>Client review or testimonial content <br> goes here for this row.
                                                    </p>
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <iframe class="w-[160px] h-[90px] "
                                                        src="https://www.youtube.com/embed/6DFyNWt2kHs" title="YouTube"
            ...
            <div class="w-[90%] mx-auto my-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <img src="/src/assets/“.png" class="w-4 h-4 mt-12" alt="quote">
                        <p class="text-black-700 text-md font-semibold mt-4 leading-relaxed">
                            The support team is amazing. They answered all my questions and helped me through every
                            step.
