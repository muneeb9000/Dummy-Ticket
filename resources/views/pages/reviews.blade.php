<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-[#F4D36B] to-[#D3F5FF] h-[256px]">
      <div class="grid grid-cols-1 md:grid-cols-2 p-2 md:p-2">
        ...
        >
          ...
          >
            Discover what our travelers are saying—real stories,
             honest reviews, unforgettable journeys. Their experiences speak louder than promises—see where trust has taken them.
          </p>
        ...
        <!-- Right Div -->
        <div
          class="justify-self-end p-s md:p-2 rounded-lg text-center w-full md:w-[499px] h-auto"
        >
          <img
    ...
    <!-- What Our Client Says -->
     <div class="w-90% mx-auto h-auto items-center justify-center text-center mt-16">
      ...
      <p class="mt-4 font-semibold Futura-Bold ">Give us feedback and let us know what experiences you had while on vacation with us</p>
     </div>
  ...
  <div class="grid [grid-template-columns:60%_40%] items-start bg-[#1960A9]">
    ...
    <div class="w-full">
      <iframe 
        ...
        src="https://www.youtube.com/embed/6DFyNWt2kHs"
    ...
    <div class="flex flex-col  text-[#1960A9] font-semibold text-sm">
      ...
      <div class="overflow-y-auto max-h-[450px] px-2 space-y-2 py-2 text-white">
        ...
        <div class="grid [grid-template-columns:35%_63%]  gap-2 bg-[#1960A9] p-2 rounded shadow">
          <div>
            <iframe class="w-[160px] h-[90px] " src="https://www.youtube.com/embed/6DFyNWt2kHs" title="YouTube" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class=" text-sm text-left">
...
<div class="w-[90%] mx-auto my-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8">
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg">
    ...
    <p class="text-black-700 text-md font-semibold mt-4 leading-relaxed">
      This is a sample review or testimonial content written by the user. It gives feedback or experience. This is a sample review or testimonial content written by the user. It gives feedback or experience.
    </p>
  </div>
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg">
    ...
    <p class="text-black-700 text-md font-semibold mt-4 leading-relaxed">
      ...
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias sint non exercitationem dolore at.
    </p>
  </div>
...
<!-- last para -->
 <div class="grid grid-cols-2 w-[70%] h-[300px] mb-32 mt-[120px] rounded-2xl mx-auto  bg-gradient-to-r from-[#FECE37] to-[#93BEEA]" >
 ...
 <!-- 2nd div -->
 <div
          class=" p-4 space-y-3 rounded-lg w-full  text-start h-auto mt-8 "
        >
        <p class="text-[#1960A9]">Stay Updated on the World of Travel</p>
          <h3
            style="font-family: 'Poppins'"
            class="text-2xl font-[500] md:text-2xl w-[480px]"
          >
          ...
          >
            <input
              ...
              class="w-[470px] px-6 py-2 outline-none"
            />
            <button
